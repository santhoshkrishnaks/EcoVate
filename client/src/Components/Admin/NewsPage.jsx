...
const NewsPage = () => {
  ...
  const handleDelete=async(id)=>{
    const deletePost=window.confirm("Are you sure you want to delete this news item?")
      ...
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        <div className="flex-1 bg-white shadow-lg rounded-lg p-6">
          ...
          <div className="space-y-4">
            {newsList.map((news) => (
              <div key={news._id} className="p-4 border border-gray-200 rounded-lg shadow-md bg-gray-50">
