...
export const Page3 = () => {
  return (
    <div className='bg-green-50'>
      ...
      <h2 className="mb-1 pt-5  text-4xl font-bold text-gray-900 justify-center text-center
      "><span className='text-green-700'>Eco</span>Corp Edge</h2>
    ...
    <div className="container relative flex flex-col justify-between  max-w-6xl px-10 mx-auto xl:px-0 mt-5">
      ...
      <div className="w-full">
        <div className="flex flex-col w-full mb-10 sm:flex-row">
          <div className="w-full mb-10 sm:mb-0 sm:w-1/2">
            <div className="relative h-full ml-0 mr-0 sm:mr-10">
              ...
              <div className="relative lg:h-[170px] p-5 bg-white border-2 border-green-500 rounded-lg">
                <div className="flex items-center -mt-1">
                  <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">Comprehensive Green Credit System</h3>
                </div>
           
                <p className="mb-2 text-gray-600">
                  EcoCorp provides an efficient and comprehensive green credit system, allowing organizations to earn points through various sustainability activities like tree plantation, water management, and waste management.
                </p>
              </div>
            </div>
          </div>
          <div className="w-full sm:w-1/2">
            <div className="relative h-full ml-0 md:mr-10">
              <span className="absolute top-0 left-0 w-full h-full mt-1 ml-1 bg-neutral-500 rounded-lg"></span>
              <div className="relative h-full p-5 bg-white border-2 border-neutral-500 rounded-lg">
                <div className="flex items-center -mt-1">
                  <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">Alignment with National Standards</h3>
                </div>
    
                <p className="mb-2 text-gray-600">
                  Our formulas and benchmarks are aligned with guidelines from the Ministry of Environment, Forest, and Climate Change, ensuring credibility and relevance to national sustainability goals.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col w-full mb-5 sm:flex-row">
          <div className="w-full mb-10 sm:mb-0 sm:w-1/2">
            <div className="relative h-full ml-0 mr-0 sm:mr-10">
              <span className="absolute top-0 left-0 w-full h-[220px] mt-1 ml-1 bg-green-500 rounded-lg"></span>
              <div className="relative lg:h-[220px] p-5 bg-white border-2 border-green-500 rounded-lg">
                <div className="flex items-center -mt-1">
                  <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">Certification and Recognition</h3>
                </div>
                
                <p className="mb-3 text-gray-600">
                  Organizations that surpass threshold values are certified as environmentally responsible entities. EcoCorp promotes transparency by publicly acknowledging and celebrating the achievements of certified organizations.
                </p>
              </div>
            </div>
          </div>
          <div className="w-full mb-10 sm:mb-0 sm:w-1/2">
            <div className="relative lg:h-[220px] ml-0 mr-0 sm:mr-10">
              <span className="absolute top-0 left-0 w-full h-full mt-1 ml-1 bg-green-500 rounded-lg"></span>
              <div className="relative h-full p-5 bg-white border-2 border-green-500 rounded-lg">
                <div className="flex items-center -mt-1">
                  <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">Data-Driven Insights</h3>
                </div>
               
                <p className="mb-2 text-gray-600">
                  EcoCorp offers data-driven insights and recommendations for continuous improvement, helping organizations track their progress and achieve higher green credit scores over time.
                </p>
              </div>
            </div>
          </div>
          <div className="w-full sm:w-1/2">
            <div className="relative lg:h-[220px] ml-0 md:mr-10">
              <span className="absolute top-0 left-0 w-full h-full mt-1 ml-1 bg-neutral-500 rounded-lg"></span>
              <div className="relative lg:h-[220px] p-5 bg-white border-2 border-neutral-500 rounded-lg">
                <div className="flex items-center -mt-1">
                  <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">Community and Collaboration</h3>
                </div>
           
                <p className="mb-2 text-gray-600">
                  EcoCorp fosters a community of environmentally conscious organizations, facilitating knowledge sharing, collaboration, and collective action towards a sustainable future.
                </p>
              </div>
            </div>
          </div>
    ...
    <section className="relative z-10 overflow-hidden bg-green-700 py-8 px-8 mt-5">
  <div className="container">
    <div className="mx-4 flex flex-wrap items-center">
      <div className="w-full px-2 lg:w-1/2">
        <div className="text-center lg:text-left">
          <div className="mb-10 lg:mb-0">
            <h1 className="mt-0 mb-3 lg:text-3xl font-bold leading-tight sm:text-4xl sm:leading-tight md:text-[40px] md:leading-tight text-white">
            Want Your Organization to Be a Part of EcoCorp? 
            </h1>
            <p className="w-full text-base font-medium leading-relaxed sm:text-lg sm:leading-relaxed text-white">
            Join EcoCorp to Green Your Corporate Practices-Apply for Early Access!
            </p>
          </div>
        </div>
      </div>
